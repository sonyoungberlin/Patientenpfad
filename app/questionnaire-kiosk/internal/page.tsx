...
export default function InternalDocumentationStartPage() {
  ...
  const [workflowId, setWorkflowId] = useState<"care_plan_v1" | "vaccination_review_v1">("care_plan_v1");
