...
- Sind Sprachbarrieren oder Einschränkungen bekannt?
...
**Wann ist der Block…**
- `GEKLAERT` – Erreichbarkeit und Kontaktwege sind vollständig dokumentiert
- `TEILWEISE_OFFEN` – Patient erreichbar, Vertreter oder bevorzugter Kanal unklar
- `OFFEN` – Kein valider Kontaktweg bekannt
...
**Kurzdefinition**
Klärt, welche relevanten Dokumente vorliegen, welche fehlen und ob vorhandene Dokumente aktuell und vollständig sind.

**Typische Teilfragen / Kette**
- Liegt ein aktueller Arztbrief vor?
- Sind Befunde der letzten Behandlung vorhanden?
- Sind Einwilligungen / Datenschutzfreigaben dokumentiert?
...
**Wann ist der Block…**
- `GEKLAERT` – Alle für den aktuellen Schritt notwendigen Dokumente liegen vor
- `TEILWEISE_OFFEN` – Kernunterlagen vorhanden, Ergänzungen ausstehend
- `OFFEN` – Wesentliche Dokumente fehlen vollständig
...
**Kurzdefinition**
Klärt den aktuellen Medikamentenstatus, offene Verordnungen und Einnahmesicherheit.

**Typische Teilfragen / Kette**
- Liegt ein aktueller Medikamentenplan vor?
- Sind alle Dauermedikamente verordnet und verfügbar?
- Gibt es bekannte Unverträglichkeiten oder Wechselwirkungsrisiken?
...
**Wann ist der Block…**
- `GEKLAERT` – Vollständiger, aktueller Medikamentenplan liegt vor, Einnahme gesichert
- `TEILWEISE_OFFEN` – Plan vorhanden, aber Lücken oder unklare Einnahme
- `OFFEN` – Kein aktueller Plan, Medikation unklar
...
**Wann ist der Block…**
- `GEKLAERT` – Alle relevanten Mitbehandler bekannt, Koordination geklärt
- `TEILWEISE_OFFEN` – Einige Mitbehandler bekannt, Vollständigkeit unklar
- `OFFEN` – Mitbehandlersituation vollständig unbekannt
...
**Kurzdefinition**
Klärt die häusliche und soziale Versorgungssituation des Patienten und ob externe Unterstützung vorhanden oder notwendig ist.
...
**Wann ist der Block…**
- `GEKLAERT` – Versorgungssituation vollständig bekannt und abgesichert
- `TEILWEISE_OFFEN` – Grundversorgung gesichert, Lücken vorhanden
- `OFFEN` – Versorgungssituation unbekannt oder ungesichert
...
**Kurzdefinition**
Klärt, ob alle Voraussetzungen für den nächsten Prozessschritt erfüllt sind und welche Freigaben oder Entscheidungen noch ausstehen.
...
- Wurde der Schritt durch die zuständige Rolle freigegeben?
...
**Wann ist der Block…**
- `GEKLAERT` – Alle Voraussetzungen erfüllt, Freigabe erteilt
- `TEILWEISE_OFFEN` – Großteils bereit, einzelne Punkte offen
- `OFFEN` – Mehrere Voraussetzungen unerfüllt
...
**Wann ist der Block…**
- `GEKLAERT` – Übergangssituation vollständig dokumentiert und versorgt
- `TEILWEISE_OFFEN` – Aufenthalt bekannt, Nachsorge lückenhaft
- `OFFEN` – Stationäre Vorgeschichte unklar, kein Entlassbrief
...
**Kurzdefinition**
Klärt, ob die relevanten Diagnosen dokumentiert, aktuell und konsistent sind.

**Typische Teilfragen / Kette**
- Sind die Hauptdiagnosen vollständig erfasst?
- Stimmen Diagnosen zwischen Praxis und externen Behandlern überein?
- Gibt es neue, noch nicht kodierte Diagnosen?
- Sind Diagnosen für den aktuellen Schritt ausreichend begründet?
...
**Wann ist der Block…**
- `GEKLAERT` – Alle relevanten Diagnosen vollständig und konsistent dokumentiert
- `TEILWEISE_OFFEN` – Kernd­iagnosen vorhanden, Ergänzungen oder Korrekturen nötig
- `OFFEN` – Diagnosenlage unklar oder widersprüchlich
