...
export type QuestionDefinition = {
  ...
  options?: QuestionOptionDefinition[];
  /** Fester Dokumentinhalt ohne Antwortfeld, z. B. ein Bibliotheksabsatz. */
  documentationText?: string;
...
export const QUESTION_CATALOG: Record<string, QuestionDefinition> = {
  ...
  ANAMNESE_GP: {
    id: "ANAMNESE_GP",
    text: "Haben Sie bereits eine andere Hausarztpraxis?",
    text_en: "Are you already registered with another GP practice?",
    type: "yes_no",
    required: true,
  },
  ANAMNESE_GP_NAME: {
    id: "ANAMNESE_GP_NAME",
    text: "Name der anderen Hausarztpraxis",
    text_en: "Name of the other GP practice",
    type: "text",
    required: true,
    helperText:
      "Alternativ: Name der dort behandelnden Hausärztin oder des Hausarztes.",
    helperText_en:
      "Alternatively, enter the name of the GP who treats you there.",
  },
  ANAMNESE_HEIGHT: {
    id: "ANAMNESE_HEIGHT",
  ...
  ANAMNESE_CHRONIC_GATE: {
    id: "ANAMNESE_CHRONIC_GATE",
    text: "Bestehen bei Ihnen chronische Erkrankungen?",
    text_en: "Do you have any chronic conditions?",
    type: "yes_no",
    required: true,
  },
  ANAMNESE_CHRONIC: {
    id: "ANAMNESE_CHRONIC",
    text: "Welche chronischen Erkrankungen bestehen?",
    text_en: "Which chronic conditions do you have?",
    type: "textarea",
    required: true,
  },
  ANAMNESE_HEREDITARY: {
  ...
  ANAMNESE_ALLERGIES_GATE: {
    id: "ANAMNESE_ALLERGIES_GATE",
    text: "Bestehen bei Ihnen Allergien oder Unverträglichkeiten?",
  ...
  ANAMNESE_ALLERGIES: {
    ...
    text_en: "Which allergies or intolerances do you have?",
    type: "textarea",
    required: true,
  },
  ANAMNESE_MEDICATIONS_GATE: {
    id: "ANAMNESE_MEDICATIONS_GATE",
    text: "Nehmen Sie regelmäßig Medikamente?",
    text_en: "Do you take any medication regularly?",
    type: "yes_no",
    required: true,
  },
  ANAMNESE_MEDICATIONS: {
    ...
    text_en: "Which medications do you take regularly?",
    type: "textarea",
    required: true,
  },
  ANAMNESE_SMOKING: {
  ...
  IMPFBERATUNG_IMPFUNGEN: {
    id: "IMPFBERATUNG_IMPFUNGEN",
    text: "Gibt es bestimmte Impfungen, zu denen Sie sich beraten lassen möchten?",
    type: "multi_select",
    required: false,
    options: [
      "Tetanus",
  ...
  IMPFBERATUNG_IMPULSQUELLE: {
    id: "IMPFBERATUNG_IMPULSQUELLE",
    text: "Wie sind Sie auf diese Impfung(en) aufmerksam geworden?",
    type: "multi_select",
    required: false,
    options: [
      "Hausarzt / Hausärztin",
      "Facharzt / Fachärztin",
      "Frauenarzt / Frauenärztin oder Hebamme",
      "Betriebsarzt / Betriebsärztin",
      "Arbeitgeber / Ausbildungsstelle",
      "Apotheke",
      "Reiseberatung / Reiseveranstalter / Behörde",
      "Familie / Freunde / Bekannte",
      "Internet / soziale Medien / andere Medien",
      "Eigene Vorsorge / selbst darauf aufmerksam geworden",
      "Ich weiß es nicht mehr / nicht genau",
    ],
  },
...
export const BLOCK_CATALOG: Record<string, QuestionnaireBlock> = {
  ...
  KURZANAMNESE: {
    ...
    conditionalRules: [
      ...
      {
        action: "showQuestion",
        targetId: "ANAMNESE_CHRONIC",
        condition: {
          target: { kind: "question", questionId: "ANAMNESE_CHRONIC_GATE" },
          operator: "equals",
          value: "ja",
        },
      },
      {
        action: "showQuestion",
        targetId: "ANAMNESE_ALLERGIES",
        condition: {
          target: { kind: "question", questionId: "ANAMNESE_ALLERGIES_GATE" },
          operator: "equals",
          value: "ja",
        },
      },
      {
        action: "showQuestion",
        targetId: "ANAMNESE_MEDICATIONS",
        condition: {
          target: { kind: "question", questionId: "ANAMNESE_MEDICATIONS_GATE" },
          operator: "equals",
          value: "ja",
        },
      },
  ...
  IMPFBERATUNG: {
    ...
    questionIds: ["VOLLST_IMPF_BEKANNT", "IMPFBERATUNG_ANLASS", "IMPFBERATUNG_IMPFUNGEN", "IMPFBERATUNG_IMPULSQUELLE", "IMPFBERATUNG_NACHWEIS_BEDARF", "IMPFBERATUNG_NACHWEIS_ZWECK", "IMPFBERATUNG_NACHWEIS_ART", "IMPFBERATUNG_NACHWEIS_FRIST"],
  },
