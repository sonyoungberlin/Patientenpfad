...
const VACCINATION_QUESTION: QuestionDefinition = {
  ...
  groupSchema: [
    ...
    { key: "custom_label", label: "Bezeichnung", type: "text", required: false, maxLength: 120, conditionalOn: "vaccination_id", conditionalValue: "other" },
    ...
    { key: "documented_season", label: "Dokumentierte Saison", type: "text", required: false, maxLength: 120, conditionalOn: "documented_status", conditionalValue: "Teilweise vorhanden" },
    ...
    { key: "note", label: "Bemerkung", type: "textarea", required: false, maxLength: 120, conditionalOn: "further_action", conditionalValues: ["Impfung ärztlich empfohlen", "Durchführung geplant / vereinbart"] },
    ...
    { key: "interval_value", label: "Nächste Dosis nach", type: "text", required: false, maxLength: 120, conditionalOn: "further_action", conditionalValues: ["Impfung ärztlich empfohlen", "Durchführung geplant / vereinbart"] },
