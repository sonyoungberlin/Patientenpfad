...
const QUESTIONS: Record<string, QuestionDefinition> = {
  HEALTH_CHECK_GENERAL_STATUS: { id: "HEALTH_CHECK_GENERAL_STATUS", text: "Allgemeinzustand", type: "yes_no", required: false, documentationItemType: "status", options: [
  ...
  HEALTH_CHECK_HEART_STATUS: { id: "HEALTH_CHECK_HEART_STATUS", text: "Herz", type: "yes_no", required: false, documentationItemType: "status", options: [
  ...
  HEALTH_CHECK_LUNG_STATUS: { id: "HEALTH_CHECK_LUNG_STATUS", text: "Lunge", type: "yes_no", required: false, documentationItemType: "status", options: [
  ...
  HEALTH_CHECK_ABDOMEN_STATUS: { id: "HEALTH_CHECK_ABDOMEN_STATUS", text: "Abdomen", type: "yes_no", required: false, documentationItemType: "status", options: [
  ...
  HEALTH_CHECK_VESSELS_PULSES_STATUS: { id: "HEALTH_CHECK_VESSELS_PULSES_STATUS", text: "Gefäße / Pulse", type: "yes_no", required: false, documentationItemType: "status", options: [
  ...
  HEALTH_CHECK_MUSCULOSKELETAL_STATUS: { id: "HEALTH_CHECK_MUSCULOSKELETAL_STATUS", text: "Bewegungsapparat", type: "yes_no", required: false, documentationItemType: "status", options: [
  ...
  HEALTH_CHECK_NEUROLOGICAL_STATUS: { id: "HEALTH_CHECK_NEUROLOGICAL_STATUS", text: "Neurologisch", type: "yes_no", required: false, documentationItemType: "status", options: [
  ...
  HEALTH_CHECK_SKIN_STATUS: { id: "HEALTH_CHECK_SKIN_STATUS", text: "Haut", type: "yes_no", required: false, documentationItemType: "status", options: [
  ...
  HEALTH_CHECK_PSYCH_STATUS: { id: "HEALTH_CHECK_PSYCH_STATUS", text: "Psychisch", type: "yes_no", required: false, documentationItemType: "status", options: [
  ...
  HEALTH_CHECK_CLINICAL_NOTE: { id: "HEALTH_CHECK_CLINICAL_NOTE", text: "Kurzer Hinweis", type: "textarea", required: false, maxLength: 120, documentationItemType: "freeText", omitDocumentationLabel: true },

  HEALTH_CHECK_BP_SYSTOLIC: { id: "HEALTH_CHECK_BP_SYSTOLIC", text: "RR systolisch", type: "number", required: false, unit: "mmHg", step: 1, documentationItemType: "measurement" },
  HEALTH_CHECK_BP_DIASTOLIC: { id: "HEALTH_CHECK_BP_DIASTOLIC", text: "RR diastolisch", type: "number", required: false, unit: "mmHg", step: 1, documentationItemType: "measurement" },
  HEALTH_CHECK_HEART_RATE: { id: "HEALTH_CHECK_HEART_RATE", text: "Herzfrequenz", type: "number", required: false, unit: "/min", unitSeparator: "", step: 1, documentationItemType: "measurement" },
  HEALTH_CHECK_BLOOD_GLUCOSE: { id: "HEALTH_CHECK_BLOOD_GLUCOSE", text: "Blutzucker", type: "number", required: false, unit: "mg/dl", step: 1, documentationItemType: "measurement" },
  HEALTH_CHECK_HEIGHT_CM: { id: "HEALTH_CHECK_HEIGHT_CM", text: "Größe", type: "number", required: false, unit: "cm", step: 0.1, documentationItemType: "measurement" },
  HEALTH_CHECK_WEIGHT_KG: { id: "HEALTH_CHECK_WEIGHT_KG", text: "Gewicht", type: "number", required: false, unit: "kg", step: 0.1, documentationItemType: "measurement" },

  HEALTH_CHECK_LIPID_PROFILE_STATUS: { id: "HEALTH_CHECK_LIPID_PROFILE_STATUS", text: "Lipidprofil", type: "select", required: false, options: LAB_STATUS_OPTIONS, documentationItemType: "measurement" },
  HEALTH_CHECK_FASTING_GLUCOSE_STATUS: { id: "HEALTH_CHECK_FASTING_GLUCOSE_STATUS", text: "Nüchternplasmaglukose", type: "select", required: false, options: LAB_STATUS_OPTIONS, documentationItemType: "measurement" },
  HEALTH_CHECK_LAB_NOTE: { id: "HEALTH_CHECK_LAB_NOTE", text: "Kurzer Hinweis", type: "textarea", required: false, maxLength: 120, documentationItemType: "freeText", omitDocumentationLabel: true },

  HEALTH_CHECK_URINE_STATUS: { id: "HEALTH_CHECK_URINE_STATUS", text: "Urinstatus", type: "select", required: false, options: LAB_STATUS_OPTIONS, documentationItemType: "measurement" },
  HEALTH_CHECK_URINE_NOTE: { id: "HEALTH_CHECK_URINE_NOTE", text: "Kurzer Hinweis", type: "textarea", required: false, maxLength: 120, documentationItemType: "freeText", omitDocumentationLabel: true },
  ...
  HEALTH_CHECK_OTHER_NOTE: { id: "HEALTH_CHECK_OTHER_NOTE", text: "Sonstiger Hinweis", type: "textarea", required: false, maxLength: 120, documentationItemType: "freeText", omitDocumentationLabel: true },

  HEALTH_CHECK_FOLLOW_UP_REQUIRED: { id: "HEALTH_CHECK_FOLLOW_UP_REQUIRED", text: "Weitere Abklärung oder Kontrolle erforderlich", type: "yes_no", required: true, options: FOLLOW_UP_OPTIONS, presentation: "health_check_follow_up", documentationItemType: "bodyText" },
  HEALTH_CHECK_NEXT_STEPS: { id: "HEALTH_CHECK_NEXT_STEPS", text: "Maßnahmen", type: "multi_select", required: false, options: NEXT_STEP_OPTIONS, documentationItemType: "listItem" },
  HEALTH_CHECK_NEXT_STEPS_NOTE: { id: "HEALTH_CHECK_NEXT_STEPS_NOTE", text: "Kurzer Hinweis", type: "textarea", required: false, maxLength: 120, documentationItemType: "freeText", omitDocumentationLabel: true },
};
