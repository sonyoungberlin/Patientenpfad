...
describe("buildMedicalRecordNote – care_plan_v1 Frozen Labels", () => {
  it("gibt den vollständigen Versorgungsplan ohne redundante Überschriften aus", () => {
    ...
    expect(note).toBe([
      ...
      "Facharztberichte - Anforderung: Patientin / Patient und Praxis",
      "Rezepte für Dauermedikation: Nach vorheriger ärztlicher Rücksprache",
      "Überweisungen: Ohne vorherige ärztliche Rücksprache",
