...
describe("buildMedicalRecordNote – care_plan_v1 Frozen Labels", () => {
  it("gibt den vollständigen Versorgungsplan ohne redundante Überschriften aus", () => {
    ...
    expect(note).toBe([
      ...
      "Die erforderlichen Facharztberichte werden durch die Patientin bzw. den Patienten und die Praxis angefordert.",
      "Rezepte für Dauermedikation werden nach vorheriger ärztlicher Rücksprache ausgestellt.",
      "Überweisungen werden ohne vorherige ärztliche Rücksprache ausgestellt.",
      "Notizen / Offene Punkte: Weitere Versorgung abstimmen",
      "",
